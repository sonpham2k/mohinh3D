var model = {
    ...
    what_is_service:
                    ...
                    <p align="justify" style="font-size: 18px;">
                        ...
                        In 3D là quá trình sản xuất ra sản phẩm thực tế bằng cách 
                        đắp chồng từng lớp vật liệu lên nhau theo đúng biên dạng của 
                        file dữ liệu 3D có sẵn. Với công nghệ này, các nhà thiết kế, 
                        kỹ sư, người làm nghiên cứu chế tạo, có thể tạo ra các mẫu thí 
                        nghiệm vật lý hoặc chi tiết có độ phức tạp cao chỉ trong vài 
                        giờ đồng hồ, với chi phí thấp hơn nhiều so với các phương thức 
                        sản xuất truyền thống khác. </br>
                    </br>
                        Nhóm mô hình 3D được thành lập với định hướng trở thành đơn vị 
                        cung cấp dịch vụ in 3D theo yêu cầu chuyên nghiệp trong và ngoài 
                        nước. Đặc biệt chúng tôi nhắm đến các sản phẩm phục vụ trong Quân 
                        đội mang tính bảo mật, yêu cầu cao và làm theo ý tưởng riêng của 
                        từng đơn vị, các nhân. Bạn chỉ cần gửi file 3D, hoặc thậm chí là 
                        chỉ cần gửi một hình ảnh phác thảo về ý tưởng của sản phẩm mà bạn 
                        cần sản xuất, các chuyên viên 3D của chúng tôi sẽ giúp bạn sản xuất 
                        ra sản phẩm thực tế đúng như yêu cầu của bạn. </br>
                    </p>
                    `,
    optimal_time:
                    `
    ...
    about_3d:
                    ...
                    <p align="justify" style="font-size: 18px;">
                        ...
                        những sa bàn kiến trúc là một công trình kiến trúc được đắp nhỏ lại để tiện 
                        ...
                        Trên thế giới đã có biết bao sa bàn về quân sự. Thiết kế sa bàn quân sự giúp 
                        dễ dàng mường tượng được địa hình chiếm đóng tại các căn cứ của quân ta hoặc 
                        kẻ địch. </br>
                        </br>
                        Sa bàn chiến tranh cung cấp cho mọi người về những chiến tích lịch sử. Sa bàn 
                        ...
                        Loại sa bàn kiến trúc nội thất thường được các nhà kiến trúc sư, kỹ thuật xây 
                        dựng chế tạo để mô phỏng các thiết kế nội thất sáng tạo hơn. Họ dễ dàng thể hiện 
                        ý tưởng thiết kế qua mô hình hữu hình, giúp mọi người dễ dàng hình dung về kiến 
                        trúc nội thất đó. </br>
                        </br>
                        Nhận ra tiềm năng về sa bàn đặc biệt là mảng về Sa bàn trong quân sự., chúng tôi 
                        đã xây dựng lên đội ngũ làm việc, chế tạo sa bàn quân sự hết sức thống nhất và 
                        chỉnh chu. Khi các đơn vị, cá nhân cần làm mô hình sa bàn về máy móc, nhà xưởng, 
                        hệ thống công nghệ, hệ thống chiến dịch của đơn vị mình nhằm mục đích trưng bày, 
                        đào tạo, bàn luận chiến thuật, phương pháp hãy liên hệ ngay với chúng tôi để được 
                    ...
                    <ul align="justify" style="font-size: 18px;">
                        ...
                        <li>Loại giấy foam với đủ màu sắc, cũng như kích thước.</li>
                        <li>Tường gạch để ốp lát hay trang trí.</li>
                        <li>Gạch để lát sàn với nhiều kiểu khác nhau.</li>
                        <li>Bảng màu gồm các loại màu thông dụng, bút vẽ.</li>
                        <li>Tấm film được dùng để làm cửa sổ hay mặt nước.</li>
                    ...
                    <p align="justify" style="font-size: 18px;">
                        ...
                        phẩm phẩm khác nhau, thời gian thi công cũng tốn kém nhiều thời gian. Cho nên chúng 
                        tôi đã sử dụng công nghệ in 3D để áp dụng vào làm các mô hình quân sự để khắc phục 
                        toàn bộ các nhược điểm trên của cách làm truyền thống. </br>
                        </br>
                        Sau khi nhận yêu cầu về mô hình, chúng tôi sẽ triển khai xây dựng bản 3D, chuyển cho 
                        khách hàng kiểm duyệt, thông qua sản phẩm, kích thước, màu sắc sản phẩm của mình bằng 
                        các hình ảnh thực tế trên phần mềm. </br>
                        </br>
                        Sau khi được duyệt về thiết kế, chúng tôi sẽ chế tạo. Dựa vào đặc điểm của từng chi 
                        tiết mà chúng tôi sẽ lựa chọn các phương pháp làm phù hợp gồm cả thủ công và máy móc. 
                        Sau khi hoàn thiện xong phần thân, các chi tiết đồng bộ thì sẽ được mang đi sơn và cuối 
                        cùng là bước hoàn thiện mô hình. </br>
                    </p>
                    `
}
